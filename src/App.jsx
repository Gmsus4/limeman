...
import { ProfilePostsViews } from "./components/Profile/ProfilePostsViews"
  ...
  return (
    <PageLayout>
      <Routes>
        ...
        <Route path='/:username/posts' element={<ProfilePostsViews />}/>
        <Route path='/:username/posts/:postID' element={<ProfilePostsViews />}/>
      </Routes>
    </PageLayout>
  )
}
